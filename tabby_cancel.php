...
<div class="body-content outer-top-xs  outer-bottom-xs">
	...
	<h2 class="heading-title">Transaction Failed</h2>
   
   
            <p class="p-style3">
            Your purchase has not been completed. Your transaction has been declined.
            </p>
        ...
        <div class="row">
            ...
            <input type="button" value="Back To Shopping Cart" name="" class="btn btn-primary btn-sm btn-block" onclick="location.href='shopping_cart.php';">&nbsp;&nbsp; 
            </div>
            <div class="col-lg-2 col-md-4 col-sm-12">
            <input type="button" value="Continue Shopping" name="" class="btn btn-primary btn-sm btn-block" onclick="location.href='index.php';">           
