...
//	$amt = $_SESSION['total_amt_for_checkout']*100;
    ...
    //$password=$row_email['confirm_pass'];
	...
	$success_message = "
		...
		<p>
			...
			This is to acknowledge that we have received payment of AED ".number_format(round($amt),2)." 
	...
	$client_message = "<table cellpadding='0' cellspacing='0' border='0' width='800' style='font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; color:#000000; line-height:18px'>
		...
		Thanks for paying through PayFort. Your invoice details are as follows:<br><br>
...
<tr>
	...
	<tr bgcolor='#CCCCCC'>
          ...
          $shipment_amount=$row_pf['shipment_amount'];
                    	...
                    	$sql = "SELECT basket_details.* FROM basket, basket_details where basket.id=basket_details.basket_id  and basket.id=".$basketid;
               ...
               <tr>
                    ...
                    <td align='right' height='30' style='border-top:1px #000000 solid;border-bottom:1px #000000 solid;border-right:1px #000000 solid;'>AED ".number_format($amt,2)."</td>
                ...
                <tr>
               	  ...
               	  <td  colspan='4' align='left' height='30' colspan='2' style='border-right:1px #000000 solid;'><strong>&nbsp;In Words :</strong>  ".convert_number(round($amt))." Dirhams Only</td>
